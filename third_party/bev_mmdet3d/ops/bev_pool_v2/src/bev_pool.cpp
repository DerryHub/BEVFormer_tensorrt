...
/*
  ...
  point, IntTensor[n_intervals] Return:
*/
void bev_pool_v2_forward(const at::Tensor _depth, const at::Tensor _feat,
                         at::Tensor _out, const at::Tensor _ranks_depth,
...
/*
  ...
  Args:
    out_grad         : grad of output bev feature, FloatTensor[b, c, h_out,
  w_out] depth_grad       : grad of input depth, FloatTensor[n, d, h, w]
    ...
    interval_lengths : starting position for pooled point,
  IntTensor[n_intervals] interval_starts  : how many points in each pooled
  point, IntTensor[n_intervals]
*/
void bev_pool_v2_backward(const at::Tensor _out_grad, at::Tensor _depth_grad,
                          at::Tensor _feat_grad, const at::Tensor _depth,
                          const at::Tensor _feat, const at::Tensor _ranks_depth,
                          const at::Tensor _ranks_feat,
                          const at::Tensor _ranks_bev,
                          const at::Tensor _interval_lengths,
                          const at::Tensor _interval_starts) {
