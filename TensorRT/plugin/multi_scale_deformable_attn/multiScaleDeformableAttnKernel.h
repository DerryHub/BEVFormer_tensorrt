...
void ms_deformable_im2col_cuda(const T *data_value,
                               ...
                               const T *data_reference_points,
                               const T *data_sampling_offsets,
...
void ms_deformable_im2col_cuda_int8(
    ...
    const int8_t *data_sampling_offsets, float scale_offset, const int8_t *data_attn_weight, float scale_weight, const int batch_size,
