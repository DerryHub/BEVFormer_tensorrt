...
class _BEVPoolV2(Function):
    ...
    def forward(ctx,
        ...
        bev_feat = bev_pool_v2_gpu(depth, feat, ranks_depth, ranks_feat, ranks_bev,
...
def bev_pool_v2_2(depth,  # N,D,H,W
                feat,  # N,H,W,C
                ranks_depth,
                ranks_feat,
                ranks_bev,
                ...
                out_height=128,
                out_width=128):
    return _bev_pool_v2_2(depth,  # N,D,H,W
                feat,  # N,H,W,C
                ranks_depth.int(),
                ranks_feat.int(),
                ranks_bev.int(),
