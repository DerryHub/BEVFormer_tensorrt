...
def build_engine(
    onnx_file, int8=False, fp16=False, int8_fp16=False, max_workspace_size=1, calibrator=None
):
...
def pth2trt(module, inputs, opset_version=13, fp16=False, int8=False, int8_fp16=False, calibrator=None):
    ...
    try:
        ...
        with open(path, "rb") as f:
            engine = build_engine(f, fp16=fp16, int8=int8, int8_fp16=int8_fp16, calibrator=calibrator)
    finally:
        os.remove(path)
    return engine
